...
var G__36889 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__36889,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__36889;
}
});
...
var or__29193__auto__ = cljs.test._STAR_current_env_STAR_;
...
var len__30465__auto___36894 = arguments.length;
var i__30466__auto___36895 = (0);
while(true){
if((i__30466__auto___36895 < len__30465__auto___36894)){
args__30472__auto__.push((arguments[i__30466__auto___36895]));

var G__36896 = (i__30466__auto___36895 + (1));
i__30466__auto___36895 = G__36896;
continue;
} else {
}
break;
...
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__30473__auto__);
});
...
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq36891){
...
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__36892,G__36893,seq36891__$2);
});
...
var file = cljs.core.get.call(null,map__36898__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__36898__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__36898__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__36898,map__36898__$1,file,line,column){
return (function (p1__36897_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__36897_SHARP_));
});})(map__36898,map__36898__$1,file,line,column))
 ...
 */
cljs.test.report = (function (){var method_table__30241__auto__ = cljs.core.atom.call(null,cljs.core.PersistentArrayMap.EMPTY);
...
return (new cljs.core.MultiFn(cljs.core.symbol.call(null,"cljs.test","report"),((function (method_table__30241__auto__,prefer_table__30242__auto__,method_cache__30243__auto__,cached_hierarchy__30244__auto__,hierarchy__30245__auto__){
return (function (m){
...
var formatter_fn = (function (){var or__29193__auto__ = new cljs.core.Keyword(null,"formatter","formatter",-483008823).cljs$core$IFn$_invoke$arity$1(cljs.test.get_current_env.call(null));
if(cljs.core.truth_(or__29193__auto__)){
return or__29193__auto__;
} else {
...
var temp__5278__auto___36900 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5278__auto___36900)){
var message_36901 = temp__5278__auto___36900;
cljs.core.println.call(null,message_36901);
} else {
}
...
var temp__5278__auto___36902 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5278__auto___36902)){
var message_36903 = temp__5278__auto___36902;
cljs.core.println.call(null,message_36903);
} else {
}
...
var output_dir__$1 = (function (){var G__36904 = output_dir;
if(!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/"))){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__36904),cljs.core.str.cljs$core$IFn$_invoke$arity$1("/")].join('');
} else {
return G__36904;
}
})();
...
var temp__5276__auto__ = (function (){var and__29181__auto__ = typeof exception.stack === 'string';
if(and__29181__auto__){
var G__36906 = exception.stack;
var G__36906__$1 = (((G__36906 == null))?null:clojure.string.split_lines.call(null,G__36906));
var G__36906__$2 = (((G__36906__$1 == null))?null:cljs.core.get.call(null,G__36906__$1,depth));
if((G__36906__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__36906__$2);
}
} else {
...
var vec__36907 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__36907,(0),null);
var column = cljs.core.nth.call(null,vec__36907,(1),null);
var vec__36910 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__36910,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__36910,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__36910,(2),null);
...
var m__$1 = (function (){var G__36913 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__36917 = (function (){var G__36916 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__36916);
} else {
return G__36916;
}
})();
...
return cljs.core.vary_meta.call(null,G__36918,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__36922 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__36922,(0),null);
var types = vec__36922;
...
return cljs.core.map.call(null,(function (p__36925){
var vec__36926 = p__36925;
var ns = cljs.core.nth.call(null,vec__36926,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__36926,(1),null);
return ((function (vec__36926,ns,vars__$1){
return (function (){
...
var G__36929 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
var G__36929__$1 = (((G__36929 instanceof cljs.core.Keyword))?G__36929.fqn:null);
switch (G__36929__$1) {
case "async":
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__36929,G__36929__$1,env,once_fixtures,each_fixtures,vec__36926,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__36929,G__36929__$1,env,once_fixtures,each_fixtures,vec__36926,ns,vars__$1){
return (function (){
var seq__36930 = cljs.core.seq.call(null,vars__$1);
var chunk__36931 = null;
var count__36932 = (0);
var i__36933 = (0);
while(true){
if((i__36933 < count__36932)){
var v = cljs.core._nth.call(null,chunk__36931,i__36933);
var temp__5278__auto___36935 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5278__auto___36935)){
var t_36936 = temp__5278__auto___36935;
each_fixture_fn.call(null,((function (seq__36930,chunk__36931,count__36932,i__36933,t_36936,temp__5278__auto___36935,v,each_fixture_fn,G__36929,G__36929__$1,env,once_fixtures,each_fixtures,vec__36926,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_36936)));
});})(seq__36930,chunk__36931,count__36932,i__36933,t_36936,temp__5278__auto___36935,v,each_fixture_fn,G__36929,G__36929__$1,env,once_fixtures,each_fixtures,vec__36926,ns,vars__$1))
);
} else {
}

var G__36937 = seq__36930;
var G__36938 = chunk__36931;
var G__36939 = count__36932;
var G__36940 = (i__36933 + (1));
seq__36930 = G__36937;
chunk__36931 = G__36938;
count__36932 = G__36939;
i__36933 = G__36940;
continue;
} else {
var temp__5278__auto__ = cljs.core.seq.call(null,seq__36930);
if(temp__5278__auto__){
var seq__36930__$1 = temp__5278__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__36930__$1)){
var c__30119__auto__ = cljs.core.chunk_first.call(null,seq__36930__$1);
var G__36941 = cljs.core.chunk_rest.call(null,seq__36930__$1);
var G__36942 = c__30119__auto__;
var G__36943 = cljs.core.count.call(null,c__30119__auto__);
var G__36944 = (0);
seq__36930 = G__36941;
chunk__36931 = G__36942;
count__36932 = G__36943;
i__36933 = G__36944;
continue;
} else {
var v = cljs.core.first.call(null,seq__36930__$1);
var temp__5278__auto___36945__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5278__auto___36945__$1)){
var t_36946 = temp__5278__auto___36945__$1;
each_fixture_fn.call(null,((function (seq__36930,chunk__36931,count__36932,i__36933,t_36946,temp__5278__auto___36945__$1,v,seq__36930__$1,temp__5278__auto__,each_fixture_fn,G__36929,G__36929__$1,env,once_fixtures,each_fixtures,vec__36926,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_36946)));
});})(seq__36930,chunk__36931,count__36932,i__36933,t_36946,temp__5278__auto___36945__$1,v,seq__36930__$1,temp__5278__auto__,each_fixture_fn,G__36929,G__36929__$1,env,once_fixtures,each_fixtures,vec__36926,ns,vars__$1))
);
} else {
}

var G__36947 = cljs.core.next.call(null,seq__36930__$1);
var G__36948 = null;
var G__36949 = (0);
var G__36950 = (0);
seq__36930 = G__36947;
chunk__36931 = G__36948;
count__36932 = G__36949;
i__36933 = G__36950;
continue;
}
} else {
...
});})(each_fixture_fn,G__36929,G__36929__$1,env,once_fixtures,each_fixtures,vec__36926,ns,vars__$1))
);
});})(each_fixture_fn,G__36929,G__36929__$1,env,once_fixtures,each_fixtures,vec__36926,ns,vars__$1))
], null);
...
break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("No matching clause: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__36929__$1)].join('')));

}
})());
});
;})(vec__36926,ns,vars__$1))
...
//# sourceMappingURL=test.js.map?rel=1502864290188
