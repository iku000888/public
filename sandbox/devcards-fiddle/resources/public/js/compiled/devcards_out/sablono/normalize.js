...
if(((cljs.core.set_QMARK_.call(null,class$)) || (cljs.core.sequential_QMARK_.call(null,class$))) && (cljs.core.every_QMARK_.call(null,(function (p1__35409_SHARP_){
return ((p1__35409_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__35409_SHARP_ === 'string');
}),class$))){
...
return cljs.core.update_in.call(null,G__35410,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"class","class",-2030961996)], null),sablono.normalize.class$);
} else {
return G__35410;
}
});
...
var len__30465__auto___35413 = arguments.length;
var i__30466__auto___35414 = (0);
while(true){
if((i__30466__auto___35414 < len__30465__auto___35413)){
args__30472__auto__.push((arguments[i__30466__auto___35414]));

var G__35415 = (i__30466__auto___35414 + (1));
i__30466__auto___35414 = G__35415;
continue;
} else {
}
break;
...
return sablono.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(argseq__30473__auto__);
});
...
var G__35412 = cljs.core.apply.call(null,cljs.core.merge,maps__$1);
if(!(cljs.core.empty_QMARK_.call(null,classes__$1))){
return cljs.core.assoc.call(null,G__35412,new cljs.core.Keyword(null,"class","class",-2030961996),classes__$1);
} else {
return G__35412;
}
});
...
sablono.normalize.merge_with_class.cljs$lang$applyTo = (function (seq35411){
return sablono.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq35411));
});
...
var vec__35418 = ((cljs.core.empty_QMARK_.call(null,matches))?(function(){throw cljs.core.ex_info.call(null,[cljs.core.str.cljs$core$IFn$_invoke$arity$1("Can't match CSS tag: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null).call(null,cljs.core.ffirst.call(null,matches)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["div",matches], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first.call(null,matches),cljs.core.rest.call(null,matches)], null)
));
var tag_name = cljs.core.nth.call(null,vec__35418,(0),null);
var names = cljs.core.nth.call(null,vec__35418,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,cljs.core.first.call(null,cljs.core.map.call(null,sablono.normalize.strip_css,cljs.core.filter.call(null,((function (matches,vec__35418,tag_name,names){
return (function (p1__35416_SHARP_){
return cljs.core._EQ_.call(null,"#",cljs.core.first.call(null,p1__35416_SHARP_));
});})(matches,vec__35418,tag_name,names))
,names))),cljs.core.vec.call(null,cljs.core.map.call(null,sablono.normalize.strip_css,cljs.core.filter.call(null,((function (matches,vec__35418,tag_name,names){
return (function (p1__35417_SHARP_){
return cljs.core._EQ_.call(null,".",cljs.core.first.call(null,p1__35417_SHARP_));
});})(matches,vec__35418,tag_name,names))
,names)))], null);
});
/**
 ...
 */
sablono.normalize.element = (function sablono$normalize$element(p__35421){
...
var tag = first__35424;
var content = seq__35423__$1;
...
var vec__35425 = sablono.normalize.match_tag.call(null,tag);
var tag__$1 = cljs.core.nth.call(null,vec__35425,(0),null);
var id = cljs.core.nth.call(null,vec__35425,(1),null);
var class$ = cljs.core.nth.call(null,vec__35425,(2),null);
...
//# sourceMappingURL=normalize.js.map?rel=1502864288493
