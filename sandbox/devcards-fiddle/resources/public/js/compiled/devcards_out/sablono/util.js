...
var x__29926__auto__ = (((x == null))?null:x);
var m__29927__auto__ = (sablono.util.to_str[goog.typeOf(x__29926__auto__)]);
if(!((m__29927__auto__ == null))){
return m__29927__auto__.call(null,x);
} else {
var m__29927__auto____$1 = (sablono.util.to_str["_"]);
if(!((m__29927__auto____$1 == null))){
return m__29927__auto____$1.call(null,x);
} else {
...
var x__29926__auto__ = (((x == null))?null:x);
var m__29927__auto__ = (sablono.util.to_uri[goog.typeOf(x__29926__auto__)]);
if(!((m__29927__auto__ == null))){
return m__29927__auto__.call(null,x);
} else {
var m__29927__auto____$1 = (sablono.util.to_uri["_"]);
if(!((m__29927__auto____$1 == null))){
return m__29927__auto____$1.call(null,x);
} else {
...
var len__30465__auto___35399 = arguments.length;
var i__30466__auto___35400 = (0);
while(true){
if((i__30466__auto___35400 < len__30465__auto___35399)){
args__30472__auto__.push((arguments[i__30466__auto___35400]));

var G__35401 = (i__30466__auto___35400 + (1));
i__30466__auto___35400 = G__35401;
continue;
} else {
}
break;
...
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(argseq__30473__auto__);
});
...
sablono.util.as_str.cljs$lang$applyTo = (function (seq35398){
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq35398));
});
...
var vec__35402 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);
...
var first_word = first__35404;
var words = seq__35403__$1;
...
var G__35405 = clojure.set.rename_keys.call(null,m,kmap);
if(cljs.core.map_QMARK_.call(null,new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(m))){
return cljs.core.update_in.call(null,G__35405,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"style","style",-496642736)], null),sablono.util.camel_case_keys);
} else {
return G__35405;
}
} else {
...
return clojure.string.join.call(null," ",cljs.core.flatten.call(null,cljs.core.map.call(null,(function (p1__35406_SHARP_){
if(typeof p1__35406_SHARP_ === 'string'){
return p1__35406_SHARP_;
} else {
return cljs.core.seq.call(null,p1__35406_SHARP_);
...
var x__$1 = this;
if(cljs.core.truth_((function (){var or__29193__auto__ = x__$1.hasDomain();
...
//# sourceMappingURL=util.js.map?rel=1502864288454
